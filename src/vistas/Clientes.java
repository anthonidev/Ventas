...
public class Clientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PanelCli.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        getContentPane().add(PanelCli);
        PanelCli.setBounds(10, 10, 1370, 920);

        setSize(new java.awt.Dimension(1392, 934));
